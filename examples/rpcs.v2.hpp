...
//==============================================================================
// definitions for example_rpcs::send_buffer
namespace hermes { namespace detail {

// Generate Mercury types and serialization functions (field names match
// those defined by send_buffer::input and send_buffer::output). These
// definitions are internal and should not be used directly. Classes
// send_buffer::input and send_buffer::output are provided for public use.
...
struct send_buffer {
    ...
    using mercury_output_type = hermes::detail::send_buffer_out_t;
...
//TODO: make private
    ...
    public:
        ...
        explicit 
        output(const hermes::detail::send_buffer_out_t& out) {
            m_retval = out.retval;
        }

        explicit 
        operator hermes::detail::send_buffer_out_t() {
            return {m_retval};
        }
